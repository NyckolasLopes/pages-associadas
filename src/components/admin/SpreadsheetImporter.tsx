...
const FIELD_MAPPINGS: FieldMapping[] = [
  ...
  { key: "foto", label: "URL da Imagem Principal (Foto)", aliases: ["url da imagem principal (foto)", "url da imagem principal", "imagem principal", "foto principal", "foto", "imagem", "imagem_url", "image_url", "image", "url foto"], required: false, type: "string" },
  { key: "imagens", label: "Imagens da Galeria (URLs separadas por vírgula)", aliases: ["imagens da galeria (urls separadas por vírgula)", "imagens da galeria", "imagens adicionais", "outras imagens", "galeria", "fotos", "imagens", "gallery"], required: false, type: "array" },
...
export const HEADERS_OFICIAIS = [
  ...
  "URL da Imagem Principal (Foto)",
  "Imagens da Galeria (URLs separadas por vírgula)",
  "Classe Terapêutica",
...
export function formatProductRow(p: Produto): any[] {
  ...
  return [
    ...
    p.foto || (Array.isArray(p.imagens) && p.imagens[0] ? (p.imagens[0].caminhoImagem || p.imagens[0]) : "") || "",
    Array.isArray(p.imagens) ? p.imagens.map((img: any) => typeof img === 'string' ? img : img.caminhoImagem).filter(Boolean).join(", ") : "",
    p.classeTerapeutica || "",
    p.alertaTexto || "",
...
const SAMPLE_ROWS = [
  [
    ...
    "https://loja.farmaciasassociadas.com/api/supabase/storage/v1/object/public/produtos/7896523207360.webp",
    "https://loja.farmaciasassociadas.com/api/supabase/storage/v1/object/public/produtos/7896523207360-1.webp, https://loja.farmaciasassociadas.com/api/supabase/storage/v1/object/public/produtos/7896523207360-2.webp",
