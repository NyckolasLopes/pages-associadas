      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Crie e gerencie as vitrines de produtos que aparecem na página inicial da sua loja.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Button onClick={() => { setEditingVitrine(null); setIsModalOpen(true); }} className="bg-[#00B5AD] hover:bg-[#009c95] text-white font-bold h-10 px-4 shadow-sm">
