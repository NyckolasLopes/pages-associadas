...
export const Route = createFileRoute("/admin/canais/farmaciasapp")({
  component: FarmaciaAppIntegrationPage,
});

function FarmaciaAppIntegrationPage() {
  ...
  const activeCount = pharmacies.filter((p) => p.vendeFarmaciaApp).length;
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto pb-10 animate-in fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white p-6 rounded-xl border shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-bold text-slate-500">Trabalham com Farmácia App</p>
          ...
          <table className="w-full text-left text-[13px]">
            <thead>
              <tr className="border-b text-slate-400 text-[11px] font-black uppercase bg-white tracking-wider">
                ...
                <th className="px-4 py-3 text-center">Trabalha com Farmácia App?</th>
              </tr>
            </thead>
