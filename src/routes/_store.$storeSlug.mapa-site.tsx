        ...
        <div className="max-w-5xl mx-auto bg-card rounded-2xl shadow-card border p-6 md:p-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Column title="Navegação Principal">
              <Row><Link to="/$storeSlug" params={{ storeSlug }} className="hover:text-primary">→ Início</Link></Row>
              <Row><Link to="/$storeSlug/busca" params={{ storeSlug }} className="hover:text-primary">→ Buscar produtos</Link></Row>
              <Row><Link to="/$storeSlug/cart" params={{ storeSlug }} className="hover:text-primary">→ Cesta</Link></Row>
              <Row><Link to="/$storeSlug/checkout" params={{ storeSlug }} className="hover:text-primary">→ Checkout</Link></Row>
              <Row><Link to="/$storeSlug/login" params={{ storeSlug }} className="hover:text-primary">→ Entrar / Cadastrar</Link></Row>
            </Column>
            ...
            <Column title="Atendimento">
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "como-comprar" }} className="hover:text-primary">→ Como Comprar</Link></Row>
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "formas-pagamento" }} className="hover:text-primary">→ Formas de Pagamento</Link></Row>
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "prazo-entrega" }} className="hover:text-primary">→ Prazo de Entrega e Retirada</Link></Row>
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "cancelamento" }} className="hover:text-primary">→ Cancelamento e Reembolso</Link></Row>
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "devolucao" }} className="hover:text-primary">→ Devolução e Trocas</Link></Row>
              <Row><Link to="/$storeSlug/faq" params={{ storeSlug }} className="hover:text-primary">→ Perguntas Frequentes (FAQ)</Link></Row>
            </Column>

            <Column title="Segurança e Privacidade">
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "protecao-dados" }} className="hover:text-primary">→ Como Protegemos Seus Dados</Link></Row>
              <Row><Link to="/$storeSlug/politica-de-privacidade" params={{ storeSlug }} className="hover:text-primary">→ Política de Privacidade</Link></Row>
              <Row><Link to="/$storeSlug/ajuda/$page" params={{ storeSlug, page: "termos-de-uso" }} className="hover:text-primary">→ Termos e Condições de Uso</Link></Row>
            </Column>
