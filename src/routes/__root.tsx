  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { name: "author", content: "Farmácias Associadas" },
        { name: "publisher", content: "Farmácias Associadas" },
        ...
        { name: "application-name", content: "Farmácias Associadas" },
        { name: "apple-mobile-web-app-title", content: "Farmácias Associadas" },
      ],
      links: [
