      ...
      loadPharmacies: async () => {
        ...
        if (!error && data) {
          const loadedPharmacies: Pharmacy[] = data.map((l: any) => ({
            ...
            pageTitle: l.tema_cores?.pageTitle || '',
            metaDescription: l.tema_cores?.metaDescription || '',
            seoDescricao: l.tema_cores?.seoDescricao || '',
            facebookPixelId: l.tema_cores?.facebookPixelId || '',
            googleAnalyticsId: l.tema_cores?.googleAnalyticsId || '',
            googleTagManagerId: l.tema_cores?.googleTagManagerId || '',
