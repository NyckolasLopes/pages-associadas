      ...
      loadPharmacies: async () => {
        ...
        if (!error && data) {
          const loadedPharmacies: Pharmacy[] = data.map((l: any) => ({
            ...
            email: l.email,
            telefone: l.telefone,
            horarioFuncionamento: l.horario_funcionamento || l.theme_colors?.horario_funcionamento,
            diasFuncionamento: l.theme_colors?.diasFuncionamento || [1,2,3,4,5,6],
            respTecnico: l.farmaceutico_responsavel || l.theme_colors?.farmaceutico_responsavel,
            inscricaoFarmaceutico: l.crf || l.theme_colors?.crf,
            alvara: l.alvara_sanitario || l.theme_colors?.alvara_sanitario,
            afe: l.afe || l.theme_colors?.afe,
            cep: l.cep || '',
            ...
            cidade: l.cidade || '',
            uf: l.estado || '',
            whatsapp: l.whatsapp || l.theme_colors?.whatsapp || '',
            pageTitle: l.theme_colors?.pageTitle || '',
            metaDescription: l.theme_colors?.metaDescription || '',
            seoDescricao: l.theme_colors?.seoDescricao || '',
            facebookPixelId: l.theme_colors?.facebookPixelId || '',
            googleAnalyticsId: l.theme_colors?.googleAnalyticsId || '',
            googleTagManagerId: l.theme_colors?.googleTagManagerId || '',
            footerPlataformaTexto: l.footer_plataforma_texto || l.theme_colors?.footer_plataforma_texto || '',
            footerDescricao: l.footer_descricao || l.theme_colors?.footer_descricao || '',
            footerTituloContato: l.footer_titulo_contato || l.theme_colors?.footer_titulo_contato || '',
            socialLinks: l.social_links || l.theme_colors?.social_links || {},
            topBarText: l.theme_colors?.topBarText || '',
            topBarBgColor: l.theme_colors?.topBarBgColor || '',
            topBarTextColor: l.theme_colors?.topBarTextColor || '',
            latitude: l.latitude,
            longitude: l.longitude,
            categoriaAssociado: l.categoria_associado || l.theme_colors?.categoria_associado,
            trabalhaComEncarte: l.trabalha_com_encarte || l.theme_colors?.trabalha_com_encarte,
            entregaExpressa: l.entrega_expressa || l.theme_colors?.entrega_expressa,
            virtualStoreStatus: l.status_loja_virtual || l.theme_colors?.status_loja_virtual,
            isVirtualStoreGenerated: !!l.status_loja_virtual,
            api_key: l.api_key,
            aceitaEntrega: l.theme_colors?.aceitaEntrega ?? false,
            modeloFrete: l.theme_colors?.modeloFrete ?? 'raio',
            horarioInicioEntrega: l.theme_colors?.horarioInicioEntrega ?? '',
            horarioFimEntrega: l.theme_colors?.horarioFimEntrega ?? '',
            horarioFimEntregaRisco: l.theme_colors?.horarioFimEntregaRisco ?? '',
            tempoEntrega: l.theme_colors?.tempoEntrega ?? '',
            custoEntrega: l.theme_colors?.custoEntrega ?? 0,
            raioEntregaKm: l.theme_colors?.raioEntregaKm,
            faixasCep: l.theme_colors?.faixasCep ?? [],
            aceitaRetirada: l.theme_colors?.aceitaRetirada ?? false,
            horarioInicioRetirada: l.theme_colors?.horarioInicioRetirada ?? '',
            horarioFimRetirada: l.theme_colors?.horarioFimRetirada ?? '',
            tempoRetirada: l.theme_colors?.tempoRetirada ?? '',
            aceitaUber: l.theme_colors?.aceitaUber ?? false,
            custoUber: l.theme_colors?.custoUber ?? 0,
            aceita99: l.theme_colors?.aceita99 ?? false,
            custo99: l.theme_colors?.custo99 ?? 0,
            aceitaMotoboy: l.theme_colors?.aceitaMotoboy ?? false,
            custoMotoboy: l.theme_colors?.custoMotoboy ?? 0,
            custoEntregaExpressa: l.theme_colors?.custoEntregaExpressa ?? 0,
